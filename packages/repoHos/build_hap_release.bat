...
set PATH=D:\Pub\bin;%JAVA_HOME%\bin;%REPO_DIR%\bin;%PATH%;E:\flutter_pub_cache\bin;C:\Program Files\Huawei\DevEco Studio\sdk\default\openharmony\toolchains;C:\Program Files\Huawei\DevEco Studio\tools\ohpm\bin
...
echo [repoHos] Building HAP (release)...
fvm.bat flutter build hap --release
